...
const AuthModal: React.FC = () => {
  const { state, login, register, closeAuthModal, setAuthMode } = useAuth();
        ...
        >
          ...
          >
            ...
            <div className="mt-6">
              ...
              <button
                type="button"
                className="mt-4 w-full bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg font-medium hover:bg-gray-50 transition-colors flex items-center justify-center"
